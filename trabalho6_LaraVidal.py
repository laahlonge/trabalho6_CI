...
for termo in all_texts:
      ...
      tf_idf1.append(f"{tf1[contador1]} * {idf[contador1]} = {valor}")
      contador1 += 1

tf_idf2 = []
for termo in all_texts:
      valor = round((tf2[contador2] * idf[contador2]), 4)
      tf_idf2.append(f"{tf2[contador2]} * {idf[contador2]} = {valor}")
      contador2 += 1

tf_idf3 = []
for termo in all_texts:
      valor = round((tf3[contador3] * idf[contador3]), 4)
      tf_idf3.append(f"{tf3[contador3]} * {idf[contador3]} = {valor}")
      contador3 += 1

tf_idf4 = []
for termo in all_texts:
      valor = round((tf4[contador4] * idf[contador4]), 4)
      tf_idf4.append(f"{tf4[contador4]} * {idf[contador4]} = {valor}")
      contador4 += 1
      
tf_idf5 = []
for termo in all_texts:
      valor = round((tf5[contador5] * idf[contador5]), 4)
      tf_idf5.append(f"{tf5[contador5]} * {idf[contador5]} = {valor}")
      contador5 += 1
